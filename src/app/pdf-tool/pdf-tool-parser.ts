...
*                .doc = PDFDocument { return PdfToolComponent.concat(group.doc, expr.doc); }
...
*                .doc = PDFDocument { return PdfToolComponent.concat(left.doc, right.doc); }
*              | left=file
*                .doc = PDFDocument { return left.doc; } 
* file        := id=num                             
*                .doc = PDFDocument { return PdfToolComponent.identity(id.value); }
* num         := val='[0-9]+'
...
export class expression_1 {
    ...
    constructor(group: fileGroup, expr: expression){
        ...
        this.expr = expr;
        this.doc = ((): PDFDocument => {
        return PdfToolComponent.concat(group.doc, expr.doc);
        })();
    }
}
...
export class fileList_1 {
    ...
    constructor(left: file, right: fileList){
        ...
        this.right = right;
        this.doc = ((): PDFDocument => {
        return PdfToolComponent.concat(left.doc, right.doc);
        })();
    }
}
...
export class file {
    ...
    constructor(id: num){
        this.id = id;
        this.doc = ((): PDFDocument => {
        return PdfToolComponent.identity(id.value);
        })();
    }
}
export class num {
